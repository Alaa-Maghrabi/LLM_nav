...
if __name__ == "__main__":
    ...
    openai_interface = GPT_Interface_Goal(key=key, model=model)

    command = 'tell me a joke'
    response = openai_interface.get_response(prompt=command)
    print(f'Response: {response}')  # wont work because it's been tailored to give coordinates
